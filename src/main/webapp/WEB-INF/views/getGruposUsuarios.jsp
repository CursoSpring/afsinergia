...
<body>
    ...
    <div class="container">
        ...
        <h4 class="text-primary"><spring:message code="gpo.usuarios.tabla.titulo"/></h4>

		<!-- Caso en que si hay gruposUsuarios -->
		<c:if test="${gruposUsuarios.size() > 0}">
		
			<!-- Llenamos la tabla con los gruposUsuarios provenientes de la bd -->
			<div class="table-responsive" id="divTablegruposUsuarios">
				<table class="table table-bordered table-hover table-condensed">
					...
					<tbody>
							...
							<c:set var="idContrato" value="${gruposUsuarios.get(0).getAfstContrato().getIdContrato()}"/>
		...
		<!-- Caso en que no hay gruposUsuarios -->
		<c:if test="${gruposUsuarios.size() < 1}">
		...
		<button class="btn btn-default btn-link btn-lg pull-right" data-toggle="modal" class="btn btn-info" href="grupoUsuario/<c:out value="${idContrato}"></c:out>" data-target="#myModal"><span class="glyphicon glyphicon-plus"></span></button>
